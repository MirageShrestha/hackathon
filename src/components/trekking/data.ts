...
export const plans: TrekPlan[] = [
  {
    ...
    itinerary: [
      {
        day: 1, title: "Kathmandu → Pokhara",
        details: "Night bus to Pokhara with dinner stop",
        breakdown: [
          { label: "Night bus to Pokhara", cost: "Rs 1,000", icon: "bus" },
          { label: "Veg dinner on the way", cost: "Rs 250", icon: "food" },
        ],
      },
      {
        day: 2, title: "Pokhara → Birethanti → Ghorepani",
        details: "Jeep + trek to Ghorepani with meals & lodge",
        breakdown: [
          { label: "Black tea (Pokhara)", cost: "Rs 60", icon: "tea" },
          { label: "Jeep to Birethanti", cost: "Rs 500", icon: "jeep" },
          { label: "Breakfast: egg, bread, potato, tea", cost: "Rs 150", icon: "food" },
          { label: "Half veg chowmein", cost: "Rs 125", icon: "food" },
          { label: "Trek to Upper Ghorepani (~10 hrs)", cost: "", icon: "trek" },
          { label: "Hotel: bed + dinner + breakfast", cost: "Rs 1,200", icon: "hotel" },
        ],
      },
      {
        day: 3, title: "Poon Hill → Tikhedhunga → Pokhara → Kathmandu",
        details: "Sunrise trek, return trek & buses back",
        breakdown: [
          { label: "Poon Hill sunrise trek (4:45 AM)", cost: "", icon: "sight" },
          { label: "Breakfast", cost: "Rs 215", icon: "food" },
          { label: "Return trek to Tikhedhunga (~4 hrs)", cost: "", icon: "trek" },
          { label: "Veg chowmein", cost: "Rs 50", icon: "food" },
          { label: "Bus to Pokhara", cost: "Rs 500", icon: "bus" },
          { label: "Chicken momo (Pokhara)", cost: "Rs 150", icon: "food" },
          { label: "Night bus to Kathmandu", cost: "Rs 1,000", icon: "bus" },
        ],
      },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: "Kathmandu → Pokhara", details: "Bus and rest",
        breakdown: [
          { label: "Tourist bus to Pokhara", cost: "Rs 1,200", icon: "bus" },
          { label: "Lunch on the way", cost: "Rs 400", icon: "food" },
          { label: "Budget hotel in Pokhara", cost: "Rs 1,200", icon: "hotel" },
        ],
      },
      { day: 2, title: "Pokhara → Jomsom", details: "Shared jeep ride",
        breakdown: [
          { label: "Breakfast in Pokhara", cost: "Rs 300", icon: "food" },
          { label: "Shared jeep to Jomsom", cost: "Rs 2,500", icon: "jeep" },
          { label: "Lunch en route", cost: "Rs 350", icon: "food" },
          { label: "Budget lodge in Jomsom", cost: "Rs 1,500", icon: "hotel" },
        ],
      },
      { day: 3, title: "Muktinath visit", details: "Temple and local meal",
        breakdown: [
          { label: "Jeep to Muktinath", cost: "Rs 800", icon: "jeep" },
          { label: "Muktinath Temple visit", cost: "", icon: "sight" },
          { label: "Dal Bhat lunch", cost: "Rs 450", icon: "food" },
          { label: "Return to Jomsom", cost: "Rs 800", icon: "jeep" },
        ],
      },
      { day: 4, title: "Marpha exploration", details: "Cafe and village walk",
        breakdown: [
          { label: "Walk to Marpha village", cost: "", icon: "trek" },
          { label: "Apple pie & coffee", cost: "Rs 350", icon: "food" },
          { label: "Village sightseeing", cost: "", icon: "sight" },
          { label: "Stay in Marpha lodge", cost: "Rs 1,000", icon: "hotel" },
        ],
      },
      { day: 5, title: "Return", details: "Jeep + bus",
        breakdown: [
          { label: "Jeep Jomsom to Pokhara", cost: "Rs 2,500", icon: "jeep" },
          { label: "Lunch en route", cost: "Rs 400", icon: "food" },
          { label: "Bus Pokhara to Kathmandu", cost: "Rs 1,200", icon: "bus" },
        ],
      },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: "Kathmandu → Pokhara", details: "Tourist bus with comfort",
        breakdown: [
          { label: "Deluxe tourist bus", cost: "Rs 1,800", icon: "bus" },
          { label: "Restaurant lunch stop", cost: "Rs 600", icon: "food" },
          { label: "Mid-range hotel (lakeside)", cost: "Rs 3,000", icon: "hotel" },
        ],
      },
      { day: 2, title: "Pokhara → Jomsom", details: "Transfer and check-in",
        breakdown: [
          { label: "Breakfast at hotel", cost: "Included", icon: "food" },
          { label: "Private jeep to Jomsom", cost: "Rs 4,000", icon: "jeep" },
          { label: "Thakali lunch", cost: "Rs 550", icon: "food" },
          { label: "Jomsom Mountain Resort", cost: "Rs 3,500", icon: "hotel" },
        ],
      },
      { day: 3, title: "Muktinath + Kagbeni", details: "Day trip with guide",
        breakdown: [
          { label: "Jeep to Muktinath", cost: "Rs 1,200", icon: "jeep" },
          { label: "Temple visit & prayer", cost: "", icon: "sight" },
          { label: "Lunch at Muktinath", cost: "Rs 500", icon: "food" },
          { label: "Kagbeni village walk", cost: "", icon: "sight" },
          { label: "Return to Jomsom", cost: "Rs 1,200", icon: "jeep" },
        ],
      },
      { day: 4, title: "Marpha cafe trail", details: "Apple products and coffee",
        breakdown: [
          { label: "Drive to Marpha", cost: "Rs 500", icon: "jeep" },
          { label: "Apple Pie Corner visit", cost: "Rs 400", icon: "food" },
          { label: "Distillery tasting", cost: "Rs 300", icon: "sight" },
          { label: "Marpha Apple Stay", cost: "Rs 3,500", icon: "hotel" },
        ],
      },
      { day: 5, title: "Return to Kathmandu", details: "Comfort return route",
        breakdown: [
          { label: "Jeep to Pokhara", cost: "Rs 4,000", icon: "jeep" },
          { label: "Lakeside lunch", cost: "Rs 700", icon: "food" },
          { label: "Tourist bus to KTM", cost: "Rs 1,800", icon: "bus" },
        ],
      },
    ],
  },
  {
    ...
    itinerary: [
      { day: 1, title: "Kathmandu → Pokhara", details: "Short flight",
        breakdown: [
          { label: "Flight KTM to Pokhara", cost: "Rs 5,000", icon: "bus" },
          { label: "Airport pickup", cost: "Included", icon: "jeep" },
          { label: "Fish Tail Lodge", cost: "Rs 8,000", icon: "hotel" },
          { label: "Fine dining dinner", cost: "Rs 1,500", icon: "food" },
        ],
      },
      { day: 2, title: "Pokhara → Jomsom", details: "Flight and pickup",
        breakdown: [
          { label: "Flight to Jomsom", cost: "Rs 6,000", icon: "bus" },
          { label: "Private jeep transfer", cost: "Included", icon: "jeep" },
          { label: "Jomsom Mountain Resort", cost: "Rs 5,500", icon: "hotel" },
        ],
      },
      { day: 3, title: "Muktinath", details: "Private jeep visit",
        breakdown: [
          { label: "Private jeep to Muktinath", cost: "Rs 3,000", icon: "jeep" },
          { label: "Guided temple tour", cost: "Rs 1,000", icon: "sight" },
          { label: "Premium lunch", cost: "Rs 800", icon: "food" },
          { label: "Muktinath Family Inn", cost: "Rs 4,000", icon: "hotel" },
        ],
      },
      { day: 4, title: "Marpha leisure day", details: "Relaxed sightseeing",
        breakdown: [
          { label: "Private transfer to Marpha", cost: "Rs 1,500", icon: "jeep" },
          { label: "Apple orchard tour", cost: "Rs 500", icon: "sight" },
          { label: "Cafe hopping", cost: "Rs 800", icon: "food" },
          { label: "Marpha Apple Stay", cost: "Rs 3,500", icon: "hotel" },
        ],
      },
      { day: 5, title: "Return", details: "Fast return",
        breakdown: [
          { label: "Jeep to Jomsom", cost: "Rs 1,500", icon: "jeep" },
          { label: "Flight to Pokhara", cost: "Rs 6,000", icon: "bus" },
          { label: "Flight to Kathmandu", cost: "Rs 5,000", icon: "bus" },
        ],
      },
    ],
  },
